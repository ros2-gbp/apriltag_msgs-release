## apriltag_msgs (rolling) - 2.0.2-1

The packages in the `apriltag_msgs` repository were released into the `rolling` distro by running `/usr/bin/bloom-release apriltag_msgs --rosdistro rolling` on `Fri, 22 May 2026 23:10:27 -0000`
...
## apriltag_msgs (lyrical) - 2.0.2-1

The packages in the `apriltag_msgs` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release apriltag_msgs --rosdistro lyrical` on `Fri, 22 May 2026 23:09:24 -0000`
...
## apriltag_msgs (jazzy) - 2.0.2-1

The packages in the `apriltag_msgs` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release apriltag_msgs --rosdistro jazzy` on `Fri, 22 May 2026 23:07:50 -0000`
